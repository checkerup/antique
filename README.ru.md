...
**280+ тестов** (на самом деле сейчас 292):
...
- `test_chain.py` — Robinhood Chain / EVM: пресеты сети, ранние покупатели, мониторинг кошельков, за моканные транспорты, интеграция MCP (НОВОЕ)
