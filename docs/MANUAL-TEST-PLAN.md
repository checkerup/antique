# Antique 0.8.0: ручной тест-план владельца

Иди строго по порядку. Не тестируй массовое удаление на рабочих профилях.

## 0. Первый запуск

Новый сводный checklist находится в `docs/OWNER-FULL-TEST-CHECKLIST.md`. Иди по нему после базового smoke.
...
4. Ожидание: версия 0.8.0, сервер не пишет traceback.
